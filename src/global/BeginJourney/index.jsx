...
function BeginJourney() {
  return (
    <div className="flex flex-col px-8 py-20 items-center justify-center">
      <div className="flex flex-col items-center md:flex-row md:justify-center md:bg-brown-accent/40 gap-20 lg:gap-0 rounded-[3rem] md:py-16 md:px-8 lg:py-20 lg:px-12 max-w-[80rem]">
        <div className="flex flex-col gap-16 lg:shrink max-w-[50%]">
