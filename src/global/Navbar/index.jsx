...
function Navbar() {
  ...
  return (
    <div className={`flex justify-between items-center w-full h-24 p-4 fixed top-0 left-0 ${isSidebarOpen ? "bg-white" : "bg-white"} shadow-md`}>
      {/* Logo */}
      <div className={`lg:w-[150px] lg:h-[51.52px] flex justify-center items-center p-0 text-xs cursor-pointer ${isSidebarOpen ? "w-[37px] h-[33.39px] bg-[url('assets/logo-icon-blue.svg')] bg-center bg-contain" : "w-[80px] h-[33.39px] bg-[url('assets/full-logo-blue.svg')] bg-contain bg-center"} lg:bg-[url('assets/full-logo-blue.svg')] bg-center bg-contain" bg-no-repeat`} />
