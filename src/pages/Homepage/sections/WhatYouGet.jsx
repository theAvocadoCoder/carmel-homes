...
function WhatYouGet() {
  ...
  return (
    <div className="flex flex-col items-center justify-between py-[4.5rem] lg:px-20 gap-[4.5rem] text-center bg-gradient-to-br from-brown-accent/30 via-white to-blue-accent/50">
      ...
      <div className="flex flex-col md:flex-row md:flex-wrap justify-center gap-12 lg:gap-20">
        {
          whatYouGetCards.map((card, index) => (
            <div key={index} className="flex flex-col items-center justify-between gap-5 px-6 py-10 rounded-[1.25rem] max-w-[17rem] md:max-w-xs bg-white shadow-[0px_0px_10px_0px] shadow-brown-gray">
