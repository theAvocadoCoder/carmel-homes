...
function Investment() {
  return (
    <section className="bg-black text-white text-[1rem] font-semibold lg:text-[1.25rem] px-14 lg:px-16 py-[9rem] lg:py-[7.5rem] [background-image:linear-gradient(to_bottom_right,black,#16293AAA_70%,#16293A30_90%,transparent_100%),url('homepage/invest.png')] bg-no-repeat bg-cover bg-center">
      <div className="flex flex-col md:max-w-[70%] lg:max-w-[40%] gap-8">
