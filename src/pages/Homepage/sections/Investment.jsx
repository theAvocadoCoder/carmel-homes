...
function Investment() {
  return (
    <div className="bg-black text-white text-[1rem] font-semibold lg:text-[1.25rem] px-14 lg:px-16 py-[9rem] lg:py-[7.5rem] [background-image:linear-gradient(to_bottom_right,black,#16293AAA_70%,#16293A30_90%,transparent_100%),url('homepage/invest.png')] bg-no-repeat bg-cover bg-center">
