...
const policyText = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        word: "Company",
        definition: " (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Carmel Homes Ltd, 336 Queenston Rd."
      },
      {
        word: "Cookies",
      ...
      {
        word: "Website",
        definition: " refers to Carmel Homes Ltd, accessible from ",
        link: ["/", "https://www.carmelhomesltd.com"]
      },
      {
        word: "You",
  ...
  {
    type: "h4",
    content: "Information from Third-party Social Medias",
  },
  {
    type: "p",
  ...
  },
  {
    ...
    withLink: true,
    content: {
      preLink: "Cookies can be “Persistent” or “Session” Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies in this ",
      link: ["https://www.termsfeed.com/blog/cookies/#What_Are_Cookies", "TermsFeed article."],
    },
  },
  {
    type: "p",
  ...
  {
    type: "ul",
    style: "tracking tech 2",
    content: [
      {
        name: "Necessary / Essential",
        type: "Session",
        purpose: "are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services."
      },
      {
      ...
      },
      {
        name: "Functionality",
        type: "Persistent",
        purpose: "allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website."
      },
    ],
  },
  {
  ...
  {
    type: "ul",
    style: "personal data 1",
    content: [
      {
        purpose: "To provide and maintain our Service",
        details: ", including to monitor the usage of our Service.",
      },
      {
        purpose: "To manage Your Account:",
      ...
      {
        purpose: "To manage Your requests:",
        details: " To attend and manage Your requests to Us.",
      },
      {
        purpose: "For business transfers:",
  ...
  {
    type: "ul",
    style: "personal data 2",
    content: [
      {
        situation: "With Service Providers:",
      ...
      {
        situation: "For business transfers:",
  ...
  {
    type: "h3",
    content: "Delete Your Personal Data",
  },
  {
    type: "p",
    content: [
  ...
  },
  {
    ...
    content: [
      {
        text: "By email: ",
        link: ["mailto:info@carmelhomesltd.com","info@carmelhomesltd.com"]
      },
      {
        text: "By visiting our ",
        link: ["/apply-now","Apply Now page."]
      },
      {
...
/**
 * for strigns use typeof
 * for arrays use instanceof
 * everything else will be an object
 * use Object.keys(<object>)[<index>] to get the property names
 */
